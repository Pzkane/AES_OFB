...
def substitute(byte):
    # https://en.wikipedia.org/wiki/Rijndael_S-box : The column is determined by the least significant nibble, and the row by the most significant nibble.
    # e.g. 9a is converted into b8 (x=9, y=a)
    x = byte >> 4
    y = byte & 15
    return s_box_aes[x][y]